...
type mapInterface interface {
	...
	LoadOrStoreFn(key interface{}, value func() interface{}) (actual interface{}, loaded bool)
	Delete(interface{})
...
func (m *RWMutexMap) LoadOrStoreFn(key interface{}, value func() interface{}) (actual interface{}, loaded bool) {
	m.mu.Lock()
	actual, loaded = m.dirty[key]
	if !loaded {
		actual = value()
...
func (m *DeepCopyMap) LoadOrStoreFn(key interface{}, value func() interface{}) (actual interface{}, loaded bool) {
	clean, _ := m.clean.Load().(map[interface{}]interface{})
	actual, loaded = clean[key]
	if loaded {
		return actual, loaded
